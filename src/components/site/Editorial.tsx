...
export function Editorial() {
  ...
  return (
    <section id="story" ref={ref} className="relative border-t border-border/60 bg-charcoal/40">
      <div className="mx-auto grid max-w-[1500px] grid-cols-1 items-stretch lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center px-5 py-20 sm:px-12 lg:px-20 lg:py-0">
          ...
          <Reveal delay={0.22}>
            <p className="mt-8 max-w-lg text-sm leading-[1.9] text-foreground/70 sm:text-base">
          ...
          <Reveal delay={0.3}>
            <p className="mt-6 max-w-lg text-sm leading-[1.9] text-foreground/55 sm:text-base">
