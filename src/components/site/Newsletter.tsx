...
export function Newsletter() {
  ...
  return (
    <section
      id="newsletter"
      className="relative overflow-hidden border-t border-border/60 py-28 sm:py-36"
    >
        ...
        <Reveal delay={0.24}>
          ...
          >
            <input
              ...
              className="w-full border border-border/70 bg-transparent px-6 py-4 text-sm text-foreground placeholder:text-muted-foreground/70 focus:border-gold/70 focus:outline-none"
            />
            <button
              type="submit"
              className="group relative overflow-hidden border border-gold/60 px-10 py-4 text-[11px] tracking-[0.28em] whitespace-nowrap text-gold uppercase transition-colors duration-500 hover:text-obsidian"
            >
